      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
            ...
            <li><a href="{{ url('/vendor/get') }}" aria-expanded="false"> <i class="fas fa-user-tie"></i>Vendedores</a> </li>
            
            <li><a href="#collapseClient"  data-toggle="collapse" aria-expanded="false" aria-controls="collapseClient"> <i class="fas fa-users"></i>Clientes </a>
              <ul id="collapseClient"class="collapse list-unstyled" >
                <li><a href="{{ url('/client/get') }}">Registrar</a></li>
                <li><a href="{{ url('/client/type') }}">Tipos</a></li>
              </ul>
            </li>
            
            <li><a href="{{ url('/product/get') }}" aria-expanded="false"> <i class="fas fa-dolly-flatbed"></i>Productos</a> </li>
            <li><a href="{{ url('/report/get') }}" aria-expanded="false"> <i class="fas fa-scroll"></i>Reportes de ventas</a> </li>
